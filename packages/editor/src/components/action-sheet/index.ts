...
export class ActionSheet {
  ...
  private _render() {
    ...
    const html = `
    <div class="ipaint-board-component-actionsheet" style="z-index: ${zIndex};">
      <div class="ipaint-board-actionsheet-mask"></div>
      <div class="ipaint-board-actionsheet-container" style="${height && height > 0 ? 'height:px' : ''};">
        <div class="ipaint-board-actionsheet-header"></div>
        <div class="ipaint-board-actionsheet-content"></div>
        <div class="ipaint-board-actionsheet-footer"></div>
      </div>
    </div>
    `;
    ...
    const component: HTMLDivElement|null = mountDom?.querySelector('div.ipaint-board-component-actionsheet')
    if (component) {
      if (mount) {
      ...
      const contentMount: HTMLDivElement|null = component.querySelector('div.ipaint-board-actionsheet-content');
  ...
  private _onEvent() {
    const mask = this._component?.querySelector('div.ipaint-board-actionsheet-mask');
