...
export class Loading {
  ...
  private _render() {
    ...
    const html = `
      <div class="ipaint-board-component-loading" style="z-index:${zIndex};">
        <div class="ipaint-board-loading-outer">
          <div class="ipaint-board-loading-inner"></div>
        </div>
      </div>
    `;
    ...
    const component: HTMLDivElement | null = tempDom.querySelector('div.ipaint-board-component-loading');
    if (component) {
