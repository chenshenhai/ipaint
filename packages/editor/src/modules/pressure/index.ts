...
export class Pressure {
  ...
  public render() {
    ...
    this._component.innerHTML = `
      <div class="ipaint-board-pressure-container">
        <div class="ipaint-board-pressure-content"></div>
      </div>
    `;
  ...
  private _onEvent() {
    ...
    const content: HTMLDivElement = this._component.querySelector('.ipaint-board-pressure-content') as HTMLDivElement;
