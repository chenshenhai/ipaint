...
export class Color {
  ...
  public render() {
    ...
    this._component.innerHTML = `
      <div class="ipaint-board-color-container" >
        <div class="ipaint-board-color-content">
          <div class="ipaint-board-color-list">
            ${colorList.map((hex: string) => {
              return `
                <div class="ipaint-board-color-item" data-color-item="${hex}">
                  <div class="ipaint-board-color-btn" style="background: ${hex}" ></div>
                </div>
              `;
            }).join('\r\n')}
          </div>
