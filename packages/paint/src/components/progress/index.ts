...
export class Progress {
  ...
  private _render() {
    ...
    const html = `
      <div class="idraw-board-component-progress" style="${styleAttr}">
        <div class="idraw-board-progress-outer">
          <div class="idraw-board-progress-inner"></div>
        </div>
      </div>
    `;
    ...
    const component: HTMLDivElement | null = tempDom.querySelector('div.idraw-board-component-progress');
    if (component) {
  ...
  private _setInnerMovePercent(percent: number) {
    const component = this._component;
    const inner = component?.querySelector('.idraw-board-progress-inner');
